...
const Footer = () => {
  return (
    <footer className='max-container'>
      <div className='flex justifty-between items-start gap-20 flex-wrap max-lg:flex-col'>
            ...
            <div key={section}>
              ...
              <ul>
                {section.links.map((link) => (
                  <li key={link.name} className='text-white-400 mt-3 text-base leading-normal hover:text-slate-gray cursor-pointer'>
                    <a href="">{link.name}</a>
                  </li>
                ))}
              </ul>
